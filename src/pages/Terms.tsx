  ...
  return (
    <div className="min-h-screen bg-bg-base px-6 pt-12 pb-16">
      <div className="mx-auto w-full max-w-2xl">
        ...
        <h1 className="text-regular-semibold text-text-primary mt-6">Terms of Service</h1>
        ...
        <div className="prose text-body text-text-primary mt-8 space-y-5">
          <h2 className="text-headline text-text-primary mt-2">Program name</h2>
          <p>Inklings Personal Receipts.</p>

          <h2 className="text-headline text-text-primary mt-6">Service description</h2>
          <p>
          ...
          <h2 className="text-headline text-text-primary mt-6">Message frequency</h2>
          <p>
            Messages are sent on-demand when a sender completes the flow in the app. There is no
            fixed schedule or recurring cadence.
          </p>

          <h2 className="text-headline text-text-primary mt-6">Message and data rates</h2>
          <p>
          ...
          <h2 className="text-headline text-text-primary mt-6">Opt-out</h2>
          <p>
          ...
          <h2 className="text-headline text-text-primary mt-6">Support</h2>
          <p>
          ...
          <h2 className="text-headline text-text-primary mt-6">Consent</h2>
          <p>
          ...
          <h2 className="text-headline text-text-primary mt-6">Prohibited use</h2>
          <p>
          ...
          <h2 className="text-headline text-text-primary mt-6">Changes</h2>
          <p>
