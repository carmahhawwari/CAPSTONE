  ...
  return (
    <div className="min-h-screen bg-white px-6 pt-12 pb-16">
      <div className="mx-auto w-full max-w-2xl">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mt-6">Terms of Service</h1>
        ...
        <div className="prose text-base text-gray-900 mt-8 space-y-5">
          <h2 className="text-lg font-semibold text-gray-900 mt-2">Program name</h2>
          ...
          <h2 className="text-lg font-semibold text-gray-900 mt-6">Message frequency</h2>
          <p>
            Messages are sent on-demand when a sender completes the flow in the app. There is no
            fixed schedule or recurring cadence.
          </p>

          <h2 className="text-lg font-semibold text-gray-900 mt-6">Message and data rates</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-gray-900 mt-6">Opt-out</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-gray-900 mt-6">Support</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-gray-900 mt-6">Consent</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-gray-900 mt-6">Prohibited use</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-gray-900 mt-6">Changes</h2>
          <p>
