...
const STYLES: TextStyle[] = ['normal', 'heading', 'handwriting', 'pixel', 'shout', 'artsy', 'decorative', 'comic', 'bold', 'liquida', 'dottonoji', 'tsuchinoko', 'redaction-10', 'redaction-35', 'redaction-50', 'redaction-70']
