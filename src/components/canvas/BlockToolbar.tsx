...
export default function BlockToolbar({ onAddText, onAddImage, onAddSticker }: BlockToolbarProps) {
  return (
    <div className="flex items-center justify-center gap-2 py-3">
      <button
        onClick={onAddText}
        className="flex items-center gap-1.5 px-4 py-2 rounded-full bg-gray-100 text-gray-700 text-sm font-medium hover:bg-gray-200 active:bg-gray-300 transition-colors"
      >
